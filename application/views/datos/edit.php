<div class="grid_8 alpha">
    ...
    <?=form::label("nombre")?>
    <?=form::input(array("id"=>"nombre","name"=>"nombre", "title"=>"Nombre", "size"=>"30", "value"=>$form['nombre']))?><br/>
    <?=form::label("calle y nro")?>
    <?=form::input(array("id"=>"calle","name"=>"calle", "title"=>"Calle", "size"=>"30", "value"=>$form['calle']))?>
